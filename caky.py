...
print(f"\033[38;5;220m║\033[0m\033[41m{' ' * 25} Jangan menyerang situs resmi PEMERINTAH {' ' * 26}\033[0m\033[37m║")
print(f"\033[38;5;220m║\033[0m\033[41m{' ' * 25} Hanya untuk memberikan Warning...!!{' ' * 28}\033[0m\033[37m║")
print(f"\033[38;5;220m╚{'═' * 76}╝")
while attemps < 100:
